...
export default function EventCard({ id, title, date, location, description, target, imageUrl }: EventCardProps) {
      ...
      <div className="bg-white text-black overflow-hidden shadow-xl transition-transform hover:scale-[1.02]">
        ...
        <div className="p-6">
          ...
          <button
            ...
            className="w-full bg-black text-white font-bold py-3 uppercase text-xs tracking-[0.2em] hover:bg-amas-orange transition"
          >
            S'inscrire
          </button>
        </div>
