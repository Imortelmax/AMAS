                            ...
                            members.map((member) => (
                                <tr key={member.id} className="border-t border-zinc-100 hover:bg-zinc-50 transition-colors">
                                    <td className="px-6 py-4">
                                        <div className="relative w-12 h-12 rounded-full overflow-hidden border-2 border-black bg-zinc-200 flex items-center justify-center">
                                            {member.imageUrl ? (
                                                <Image src={member.imageUrl} alt={member.firstname} fill className="object-cover" />
                                            ) : (
                                                <span className="text-zinc-500 font-black text-lg">{member.firstname[0]}</span>
                                            )}
                                        </div>
                                    </td>
